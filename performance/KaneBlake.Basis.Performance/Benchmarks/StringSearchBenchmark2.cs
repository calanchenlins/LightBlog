...
{
    public class StringSearchBenchmark2
    {
...
(@p1211, @p1212, @p1213, @p1214, @p1215, @p1216, @p1217, @p1218, @p1219, @p1220, @p1221, @p1222, @p1223, @p1224, @p1225, @p1226, @p1227, @p1228, @p1229, @p1230, @p1231, @p1232, @p1233, @p1234, @p1235);";
        ...
        public StringSearchBenchmark2()
        {
        }


        [Benchmark]
        public bool IndexOfSearch()
        {
            var seekString = "SELECT @@ROWCOUNT;";
            return commandText.IndexOf(seekString, StringComparison.Ordinal) != -1;
        }
        ...
        {
            var seekString = "SELECT @@ROWCOUNT;";
            return commandText.Contains(seekString, StringComparison.Ordinal);
        }
    }
}
