...
namespace KaneBlake.AspNetCore.Extensions.MVC.ModelBinding.Binders
{
    ...
    public class DateTimeOffsetModelBinder : IModelBinder
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="DateTimeOffsetModelBinder"/>.
        /// </summary>
        /// <param name="supportedStyles">The <see cref="DateTimeStyles"/>.</param>
        /// <param name="loggerFactory">The <see cref="ILoggerFactory"/>.</param>
        public DateTimeOffsetModelBinder(DateTimeStyles supportedStyles, ILoggerFactory loggerFactory)
        {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            try
            {
                ...
                {
                    if (DateTimeOffset.TryParse(value, valueProviderResult.Culture, _supportedStyles, out var modelValue))
                    {
                        model = modelValue;
                    }
                    else if (double.TryParse(value, out var unixTimeStamp))
                    {
                        model = DateTimeOffset.UnixEpoch.AddMilliseconds(unixTimeStamp);
                    }
                }
