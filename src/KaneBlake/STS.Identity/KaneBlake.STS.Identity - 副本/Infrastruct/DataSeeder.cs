    ...
    public class DataSeeder
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            ...
            return new List<ApiResource>{
                // 定义微服务中需要用到的claims
                new ApiResource("orders", "订单Api微服务"),//orderClaimTypes
                new ApiResource("catalog.api", "目录微服务"),//catalogClaimTypes
                new ApiResource("OcelotGateway", "网关认证模式")//OcelotGatewayClaimTypes
            };
        }
